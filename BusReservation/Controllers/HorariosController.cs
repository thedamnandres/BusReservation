...
namespace BusReservation.Controllers
{
    public class HorariosController : Controller
    {
        ...
        public HorariosController(BusReservationContext context)
        {
            _context = context;
        }
        ...
        {
            var busReservationContext = _context.Horario.Include(h => h.Ruta);
        ...
        public async Task<IActionResult> Create([Bind("HorarioId,RutaId,FechaHoraSalida,AsientosDisponibles,AsientosOcupados")] Horario horario)
        {
            ...
            ViewData["RutaId"] = new SelectList(_context.Set<Ruta>(), "RutaId", "Destino", horario.RutaId);
            return View(horario);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HorarioId,RutaId,FechaHoraSalida,AsientosDisponibles,AsientosOcupados")] Horario horario)
        {
